...
class ArticleController extends Controller
{
    ...
    */
    ...
    public function store(Request $request) {
      ...
      $headline_uri = EncodeURIComponentService::make(
        PrettifyURIComponentService::make($data['headline'])
      );
      ...
      $articlePath = SafeObjectKeyService::make($username ? $author->username : $currentUser->username) . '/articles/' . SafeObjectKeyService::make($headline_uri);
    ...
    public function edit(Request $request) {
      ...
      $new_headline_uri = EncodeURIComponentService::make(
        PrettifyURIComponentService::make($data['headline'])
      );
