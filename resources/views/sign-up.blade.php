...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
      ...
      <title>Sign up - The Copenhagen Gates</title>
    </head>
    <body class="antialiased">
      <div class="vh-100">
        <main class="d-flex justify-content-center align-items-center flex-column form-signin form-signin">
            <div class="fixed-top">
              <nav class="mb-auto w-100 navbar navbar-light bg-white border-bottom"> <!-- shadow-sm -->
            ...
            <div class="d-flex align-items-center vh-100 form-signin">
              <div class="my-3 container rounded-5" style="max-width: 500px;">
                ...
                <div class="modal-body p-5 pt-0">
                  <form id="sign-up-form" action="http://127.0.0.1:8000/auth/signin" method="post" class="">
                    <input type="hidden" name="_token" value="wFRYeVHTKXLOXcpLcmzJUcIgLbXbVr52uRYz91PN">                        <!-- <div class="alert alert-danger" role="alert">
            ...
            <!--
            <footer class="fixed-bottom container py-3">
