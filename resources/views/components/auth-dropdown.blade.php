<div @class(['dropdown', 'nav' , 'd-sm-block' , 'order-lg-3' , $direction ?? '' ])>
    ...
    <div @class(['dropdown-menu', $menu_alignment ?? 'dropdown-menu-end' , 'my-1' ])>
        ...
        <a class="dropdown-item d-flex align-items-center" href="{{route('manage_layout')}}"><i class="ai-layout-side fs-lg opacity-70 me-2"></i>{{__('messages.layout')}}</a>
        @endif
        <div class="dropdown-divider"></div>
        @endif
