<section class="container py-5 my-lg-3 my-xl-4 my-xxl-5 aos-init aos-animate" data-aos="fade-up" data-aos-duration="600" data-aos-offset="280" data-disable-parallax-down="md">
    <div class="row align-items-xl-center py-2 py-sm-3 my-md-3 mb-lg-4 mb-xl-5">
        ...
        @endif
        <div @class(["align-self-center col-md-6 col-xl-5 aos-init aos-animate", "offset-xl-1" => isset($text_position) == false || (isset($text_position) && $text_position == 'start')]) data-aos="fade-up" data-aos-duration="850" data-aos-offset="180" data-disable-parallax-down="md">
