 @for ($i = 0; $i < floor(isset($placeholder) && $placeholder==true ? $n/4 : count($articles)/4); $i++) <div style="margin: auto;" class="articles-grid row pb-lg-0 px-0 py-0 py-md-2 py-lg-5">
