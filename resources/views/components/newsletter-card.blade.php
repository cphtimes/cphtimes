<section class="container mb-2 mb-md-3 mb-xl-4 pb-2">
    <div class="border position-relative rounded-0 overflow-hidden p-md-5 p-4">
    <div class="position-absolute top-0 start-0 w-100 h-100"></div>
    <div class="position-relative p-xl-5 p-md-4 py-4 px-sm-3">
        <h2 class="h1 pb-md-4 pb-3 mt-n2 serif fw-bolder fst-italic">Stay up to date with important news!</h2>
