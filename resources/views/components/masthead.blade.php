    ...
    <div class="container pt-lg-3">
        ...
        <div style="height: 60px;" class="row">
            <div class="col-4 ps-0">
                ...
                <button disabled onclick="window.autocomplete.openAutoComplete()" type="button" @class([ 'btn' , 'btn-link' , 'text-dark' , 'btn-sm' ])>
                    <i class="ai-search"></i>
                </button>
            </div>
            ...
            <div class="col-4 d-flex justify-content-end">
                <div class="px-2">
                    <a href="/meetings" @class([ 'btn' , 'btn-link' , 'text-dark' , 'btn-sm' , 'd-none' ])>
                        <i class="bi bi-plus-circle"></i>
                    </a>
                    <button id="header__moon" onclick="window.darkmode.toLightMode()" type="button" @class([ 'd-none'=> $darkMode == false,
                        'btn',
                        'btn-link',
                        'text-dark',
                        'btn-sm'
                    ...
                    <button id="header__sun" onclick="window.darkmode.toDarkMode()" type="button" @class([ 'd-none'=> $darkMode == true,
                        'btn',
                        'btn-link',
                        'text-dark',
                        'btn-sm'
