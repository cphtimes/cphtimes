...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
      <main class="main">
        ...
        <nav class="sticky-top navbar navbar-light bg-white shadow-sm">
          <div class="d-flex justify-content-between container-fluid">
            ...
            <div class="text-center">
              ...
              <small class="fw-bold d-none">{!! $article->headline !!}</small>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-9 col-xl-8 pe-lg-4 pe-xl-0 pt-4">
            ...
            <div class="position-sticky top-0 mt-2 mt-md-3 mt-lg-0" style="padding-top: 7rem;">
              ...
              <div class="mt-n3 ms-n3 mb-lg-5 mb-4 pb-3 pb-lg-0">
                <a class="btn btn-outline-secondary btn-icon btn-sm btn-instagram rounded-circle mt-3" href="#">
                ...
                <a class="btn btn-outline-secondary btn-icon btn-sm btn-facebook rounded-circle mt-3 ms-3" href="#">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                  </svg>
                </a>
                <a class="btn btn-outline-secondary btn-icon btn-sm btn-telegram rounded-circle mt-3 ms-3" href="#">
