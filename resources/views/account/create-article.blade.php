...
<head>
    ...
    <title>{{__('messages.new_article')}} - {{ __('messages.brand_name') }}</title>
    <meta name="description" content="">

    <!-- Google / Search Engine Tags -->
    <meta itemprop="name" content="{{__('messages.new_article')}} - {{ __('messages.brand_name') }}">
    ...
    <meta property="og:title" content="{{__('messages.new_article')}} - {{ __('messages.brand_name') }}">
    ...
    <meta name="twitter:title" content="{{__('messages.new_article')}} - {{ __('messages.brand_name') }}">
