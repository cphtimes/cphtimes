...
<head>
    ...
    <meta itemprop="name" content="{{__('messages.login_title')}} - {{ __('messages.brand_name') }}">
    ...
    <meta property="og:title" content="{{__('messages.login_title')}} - {{ __('messages.brand_name') }}">
    ...
    <meta name="twitter:title" content="{{__('messages.login_title')}} - {{ __('messages.brand_name') }}">
